...
#define CCAN_CFLAGS "-O2 -g3 -ggdb -Wall -Werror -Wstrict-prototypes -Wold-style-definition -Wundef -Wmissing-prototypes -Wmissing-declarations -Wpointer-arith -Wwrite-strings -DCCAN_STR_DEBUG=1 -I."
